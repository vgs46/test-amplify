        ...
        >
          ...
          >
            ...
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="If you are managing marathon photographs, try out the tool to see how easy it is launch pages, transact with users, send notifications to participants, all at one place"
              {...getOverrideProps(
                overrides,
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco."
              )}
